...
class TestDbWrapper:
    ...
    def test_get_all_posts(self, mock_db_pool):
        ...
        mock_posts = [
            {'post_id': 1, 'author': 'user1', 'title': 'Post 1', 'content': 'Content 1', 'date_posted': mock_date},
            {'post_id': 2, 'author': 'user2', 'title': 'Post 2', 'content': 'Content 2', 'date_posted': mock_date}
        ]
